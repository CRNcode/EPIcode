...
// To examine the effect of varying the mean leak on mean
// outbreak size. Expect sigmoidal respose for large compartments.
// Response can look more linear when compartments are small
